...
module.exports = function(oAccessory, oService, oCharacteristic, ouuid) {
    if (oAccessory) {
        ...
        inherits(MyAccessory, Accessory);
        MyAccessory.prototype.loadData = loadData;
        MyAccessory.prototype.getServices = getServices;
    }
    return MyAccessory;
};
...
class MyAccessory {
    constructor(platform, device) {
        // console.log("MyAccessory: ", platform, device);
